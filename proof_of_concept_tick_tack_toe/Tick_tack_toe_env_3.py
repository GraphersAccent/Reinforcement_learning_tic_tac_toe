...
class TicTacToeEnv(gym.Env):
    ...
    def __init__(self, render_mode=None, random_monte_carlo= True, simulations=100, loss_reward=-1.0, win_reward=1.0, draw_reward=0.0):
        ...
        self.random_monte_carlo = random_monte_carlo
    ...
    def step(self, action):
        ...
        if terminated:
            if winner == self.current_player:
                ...
                reward = self.loss_reward # loss, mostly not possable when you are playing
            
        else:
            if self.random_monte_carlo:
    ...
    def _monte_carlo_simulation(self, board, player, gamma = 0.55):
            ...
            while True:
                ...
                if terminated:
                    if winner == player:
                        ...
                        cumulative_reward += self.loss_reward # Loss
                    simulations += 1
                    break
